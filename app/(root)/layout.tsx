...
export default function HomeLayout({
  ...
  return (
    <>
      ...
      />
       <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-white [radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-black"/>
